...
#define ___JYFR_JYM_SAFEALLOCATOR_H___OPERATORS___	 	inline T* operator->()						\
														{	if(m_pPointRef != NULL)					\
...
namespace SafeAllocator
{
	...
	public:
		...
		public:
			T*				m_pPointer;
			DWORD			m_dwRefCount;
			DWORD			m_dwWeakRefCount;
			CSectionLock	m_lkRefCount;
			CSectionLock	m_lkWeakRefCount;
			CSectionLock	m_lkPointer;
...
//namespace SafeAllocatorMultiThread
//{
//};
